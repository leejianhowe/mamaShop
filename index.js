...
app.post("/create-checkout-session", async (req, res) => {
    ...
    try {
        ...
        const session = await stripe.checkout.sessions.create({
            ...
            customer_email:user,
            success_url: 'http://sgmamashop.herokuapp.com//#/payment-status?session_id={CHECKOUT_SESSION_ID}&status=success',
            cancel_url: 'http://sgmamashop.herokuapp.com//#/payment-status?session_id={CHECKOUT_SESSION_ID}&status=fail',
        });
        console.log('session',session)
